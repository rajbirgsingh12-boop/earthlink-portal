...
export default function PortalLayout({ children }: { children: React.ReactNode }) {
  ...
  if (role === "admin" || role === "office") {
    tabs.push(["/items", "Price Book"], ["/proposals", "Proposals"], ["/payroll", "Payroll"], ["/statements", "Invoices & Statements"], ["/settings", "Settings"]);
  } else if (role === "accountant") {
    tabs.push(["/payroll", "Payroll"], ["/statements", "Invoices & Statements"]);
  }
